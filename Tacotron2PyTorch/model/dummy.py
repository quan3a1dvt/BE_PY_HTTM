...
from Tacotron2PyTorch.model.layers import ConvNorm, LinearNorm
from Tacotron2PyTorch.utils.util import mode, get_mask_from_lengths
...
class Decoder(nn.Module):
    ...
    def inference(self, memory):
        ...
        while True:
            ...
            if torch.all(torch.sigmoid(gate_output.data) > hps.gate_threshold):
